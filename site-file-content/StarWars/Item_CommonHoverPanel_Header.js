...
,'            </div>'
            ...
            if (showFileIcon) {
ms_outHtml.push(''
,'                <img class="ms-srch-item-icon ms-positionRelative" id="', $htmlEncode(id + Srch.U.Ids.icon) ,'" onload="this.style.display=\'inline\';this.style.bottom=\'-5px\'" src="', $urlHtmlEncodeString(Srch.U.getIconUrlByFileExtension(ctx.CurrentItem)) ,'" />'
);
            }	
