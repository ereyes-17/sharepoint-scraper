...
,'                            <img id="', $htmlEncode(id + HP.ids.preview) ,'" alt="', $htmlEncode(Srch.Res.hp_Alt_ImagePreview) ,'" src="', $urlHtmlEncodeString(ctx.CurrentItem.PictureURL) ,'" onload="this.style.display=\'block\';" />'
,'                        </div>'
);
                    }
