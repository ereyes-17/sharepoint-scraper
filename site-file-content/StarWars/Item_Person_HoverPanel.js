...
,'                                <img src="', $urlHtmlEncodeString(SP.Utilities.VersionUtility.getImageUrl(Srch.SU.closeImage)) ,'" alt="', $htmlEncode(Srch.Res.hp_Tooltip_Close) ,'" />'
,'                            </a>'
,'                        </div>'
...
,'                            <a id="', visitId ,'" class="ms-calloutLink ms-uppercase" href="', $urlHtmlEncodeString(ctx.CurrentItem.Path) ,'" title="', $htmlEncode(Srch.Res.hp_PeopleItem_ViewProfile) ,'">'
