function ULSSem(){var o=new Object;o.ULSTeamName="Search Server";o.ULSFileName="Item_PowerPoint_HoverPanel.js";return o;}
function DisplayTemplate_23bf5e8ec1034e6db5da60fb5075c4b4(ctx) {ULSSem:;
  var ms_outHtml=[];
  var cachePreviousTemplateData = ctx['DisplayTemplateData'];
  ctx['DisplayTemplateData'] = new Object();
  DisplayTemplate_23bf5e8ec1034e6db5da60fb5075c4b4.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fSearch\u002fItem_PowerPoint_HoverPanel.js';
  ...
  ctx['ItemValues'] = function(slotOrPropName) {ULSSem:;
...
,'            <div class="ms-srch-hover-content" id="', $htmlEncode(id + HP.ids.content) ,'" data-displaytemplate="PowerPointHoverPanel">'
...
ms_outHtml.push(''
,'                                    <a clicktype="HoverSection" linkIndex="', $htmlEncode(i) ,'" href="', $urlHtmlEncodeString(ctx.CurrentItem.ServerRedirectedURL + encodedSlideIndex) ,'" target="_blank">'
...
,'            </div>'
            ...
            if(!Srch.U.n(ctx.CurrentItem.ServerRedirectedEmbedURL)){
                AddPostRenderCallback(ctx, function(){ULSSem:;
...
function RegisterTemplate_23bf5e8ec1034e6db5da60fb5075c4b4() {ULSSem:;

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("Item_PowerPoint_HoverPanel", DisplayTemplate_23bf5e8ec1034e6db5da60fb5075c4b4);
}

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fSearch\u002fItem_PowerPoint_HoverPanel.js", DisplayTemplate_23bf5e8ec1034e6db5da60fb5075c4b4);
}

}
RegisterTemplate_23bf5e8ec1034e6db5da60fb5075c4b4();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fSearch\u002fItem_PowerPoint_HoverPanel.js"), RegisterTemplate_23bf5e8ec1034e6db5da60fb5075c4b4);
}
