...
,'                            </span>'
,'                            <a clicktype="Result" id="', $htmlEncode(id + Srch.U.Ids.titleLink) ,'" href="', $urlHtmlEncodeString(ctx.CurrentItem.Path) ,'" class="ms-srch-item-link" title="', $htmlEncode(ctx.CurrentItem.Title) ,'" onfocus="', showHoverPanelCallback ,'">'
...
,'                            <img class="ms-comm-bestResponseIcon" src="', $urlHtmlEncodeString(GetThemedImageUrl('spcommon.png')) ,'" />'
,'                        </span>'
