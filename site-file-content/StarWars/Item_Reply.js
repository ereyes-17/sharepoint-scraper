...
,'                            </span>'
,'                            <a clicktype="Result" id="', $htmlEncode(id + Srch.U.Ids.titleLink) ,'" href="', $urlHtmlEncodeString(ctx.CurrentItem.Path) ,'" class="ms-srch-item-link" title="', $htmlEncode(title) ,'" onfocus="', showHoverPanelCallback ,'">'
