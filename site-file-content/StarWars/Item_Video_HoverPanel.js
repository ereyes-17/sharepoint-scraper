...
{ULSd0a:;
    ...
    EnsureScriptFunc("videoportal.js", "VideoPortal", function() {ULSd0a:;
...
window.SearchJSBridgedCallback = function(playerElementId){ULSd0a:;
...
var oldState;
window.onMediaPlayerStateChange = function (state, playerId) {ULSd0a:;
