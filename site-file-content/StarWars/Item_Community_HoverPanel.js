...
,'                        <img id="', $htmlEncode(id + HP.ids.siteLogo) ,'" alt="', $htmlEncode(Srch.Res.hp_Alt_SiteLogo) ,'" src="', $urlHtmlEncodeString(ctx.CurrentItem.SiteLogo) ,'" onload="this.style.display=\'block\';" />'
,'                    </div>'
);
                }
...
,'                        <a clicktype="ActionEdit" id="', $htmlEncode(id + HP.ids.openClient) ,'" class="ms-calloutLink ms-uppercase" href="', $urlHtmlEncodeString(ctx.CurrentItem.Path) ,'">'
