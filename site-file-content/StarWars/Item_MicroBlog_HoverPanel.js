...
,'                                    <img id="PostCalloutPicture" src="', $urlHtmlEncodeString(ctx.CurrentItem.AttachmentURI) ,'" alt="', $htmlEncode(ctx.CurrentItem.AttachmentDescription) ,'" />'
,'                                </div>'
);
                            }
ms_outHtml.push(''
...
,'                        <a clicktype="ActionEdit" id="', $htmlEncode(viewConversationLinkId) ,'" class="ms-calloutLink ms-uppercase" href="', $urlHtmlEncodeString(threadLink) ,'">'
